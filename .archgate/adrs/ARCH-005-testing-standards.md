...
- **Lint-enforced test hygiene** — custom oxlint plugins catch assertion-less tests, unguarded env restores, and mocks of modules the whole run shares before CI runs the suite.
