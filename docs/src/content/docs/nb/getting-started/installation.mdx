...
Etter installasjonen, kjør `archgate init` i prosjektet ditt for å sette opp styring. Se guiden [Hurtigstart](/getting-started/quick-start/) for en gjennomgang.

:::tip[Editorplugins (beta)]
Vil du at AI-agenten din skal lese ADR-er før den koder og validere etterpå? Editorpluginene for [Claude Code](/guides/claude-code-plugin/) og [Cursor](/guides/cursor-integration/) legger til en komplett styringsarbeidsflyt på toppen av CLI-en. Kjør `archgate login` for å registrere deg og komme i gang.
:::
