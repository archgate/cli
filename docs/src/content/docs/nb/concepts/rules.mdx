...
Det er denne koblingen som gjør Archgate til lint-steget for AI-arbeid: hver kontroll sporer tilbake til en dokumentert beslutning, og brudd peker på filen og linjen som brøt den når reglene oppgir dem.
