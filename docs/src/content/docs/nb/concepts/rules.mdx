...
Det er denne koblingen som gjør Archgate til lint-steget for AI-arbeid: hver kontroll sporer tilbake til en dokumentert beslutning, og hvert brudd peker på filen og linjen som brøt den.
