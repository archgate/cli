...
description: "Lær hvordan Architecture Decision Records (ADR-er) fungerer i Archgate: lesbare guardrails som AI-agenter følger, sammen med maskinsjekkbare regler som håndhever dem."
---
...
Archgate bygger videre på ADR-konseptet ved å gi hver beslutning to uttrykk: et **dokument** som mennesker og AI-agenter leser, og en valgfri **regelfil** som maskiner kjører. Dokumentet er guardrailen agentene dine følger før de skriver. Regelfilen er kontrollen som blokkerer det som slipper gjennom.
