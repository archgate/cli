...
Pluginen legger til en agent og rollebaserte ferdigheter i Claude Code. Agenten orkestrerer guardrails-arbeidsflyten, og aktiverer ferdigheter etter behov -- les beslutninger før koding, valider etterpå, og fang opp nye mønstre for teamet.
