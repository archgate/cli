...
Regler er TypeScript-funksjoner som linter kodebasen din mot teamets beslutninger. De ligger i tilhørende `.rules.ts`-filer ved siden av ADR-markdown-filer og kjøres når du utfører `archgate check`.
