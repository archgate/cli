...
| 1    | Ett eller flere brudd oppdaget, advarsler overskred `--max-warnings`, eller `--strict` fant veiledende funn. |
...
Behandle enhver regelbasert advarsel og ethvert veiledende funn (sammendragsbudsjett, undertrykkelse, utolkede ADR-er) som en feil:
