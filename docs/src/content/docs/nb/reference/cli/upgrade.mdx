...
CLI-en autodetekterer installerte editorer (Claude Code, Cursor, VS Code, GitHub Copilot, opencode) og kjører plugin-installasjonen for hver valgte editor. Feil ved plugin-oppdatering rapporteres, men påvirker ikke avslutningskoden -- selve CLI-oppgraderingen er allerede fullført.
