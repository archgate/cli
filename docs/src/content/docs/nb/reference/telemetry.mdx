...
- **Kommandonavn** og **hvilke flagg som ble brukt** (f.eks. `check --output json`; kun flaggtilstedeværelse, aldri flaggverdier)
...
- **Ingen flaggverdier**: vi registrerer at `--output json` ble brukt, ikke hva JSON-utdataene inneholdt
