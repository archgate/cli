...
The editor plugins for [Claude Code](/guides/claude-code-plugin/) and [Cursor](/guides/cursor-integration/) automate the governance workflow using CLI commands directly (not via MCP). Your agent reads ADRs, validates compliance, and captures learnings without you invoking any tools manually. [Sign up for beta access](https://plugins.archgate.dev).
:::
