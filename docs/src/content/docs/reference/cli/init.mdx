...
:::tip
After initialization, you can configure a custom directory for ADRs by editing `.archgate/config.json`. See the [Configuration reference](/reference/configuration/#custom-adr-directory) for details.
:::
