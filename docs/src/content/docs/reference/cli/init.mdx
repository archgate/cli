...
Creates the `.archgate/` directory with an example ADR and a linter rules directory. Optionally configures editor integration for AI agent workflows and installs the Archgate editor plugin.
