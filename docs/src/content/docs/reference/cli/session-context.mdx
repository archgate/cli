...
| Option              | Description                                                                                         |
| ------------------- | --------------------------------------------------------------------------------------------------- |
| `--editor <name>`   | Editor to read: `claude-code`, `copilot`, `cursor`, or `opencode`. Defaults to the detected editor. |
