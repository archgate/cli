...
description: Set up the Archgate plugin for GitHub Copilot CLI. Add architecture guardrails to Copilot with automated ADR compliance and rule enforcement.
---
