...
| `--list`            | Lista as sessões disponíveis do projeto em vez de ler uma |
...
| ------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `--max-entries <n>` | Máximo de entradas a retornar (padrão: 200)                                                                          |
| `--list`            | Lista as sessões de nível superior disponíveis do projeto em vez de ler uma                                          |
| `--session-id <id>` | ID específico da sessão a ser lida                                                                                   |
...
Listar as sessões disponíveis do projeto:

```bash
archgate session-context claude-code --list
```

Ler uma sessão anterior específica por ID:
