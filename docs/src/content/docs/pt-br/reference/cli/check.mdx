...
| 1      | Uma ou mais violações detectadas, avisos excederam `--max-warnings`, ou `--strict` encontrou achados consultivos. |
...
Tratar qualquer aviso de severidade de regra e qualquer achado consultivo (orçamento do resumo, supressão, ADRs não analisados) como falha:
