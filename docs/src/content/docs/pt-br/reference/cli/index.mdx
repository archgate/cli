...
description: "Referência completa de todos os comandos da CLI do Archgate: init, check, adr, login, credential, plugin, review-context, session-context, upgrade, doctor, clean e telemetria."
---
...
| `--log-level <level>` | Define a verbosidade do log: `error`, `warn`, `info` (padrão) ou `debug` |
...
| Comando                                          | Descrição                                                      |
| ------------------------------------------------ | -------------------------------------------------------------- |
| [`archgate login`](./login/)                     | Entre na plataforma Archgate                                   |
| [`archgate credential`](./credential/)           | Credential helper do git para repositórios de plugins archgate |
...
| [`archgate telemetry`](./telemetry/)             | Gerenciar a coleta anônima de dados de uso                     |
