...
- **Localização aproximada**: país e região (resolvidos no servidor a partir do seu IP, que é descartado em seguida, conforme [Anonimização de IP](#anonimização-de-ip))
