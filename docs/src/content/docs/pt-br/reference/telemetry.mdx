...
- **Nome do comando** e **quais flags foram usadas** (ex: `check --output json`, apenas a presença da flag, nunca valores)
...
- **Nenhum valor de flag**: registramos que `--output json` foi usado, não o conteúdo da saída JSON
