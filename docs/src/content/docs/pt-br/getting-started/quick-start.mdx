...
Os arquivos gerados fornecem um exemplo funcional para você construir a partir dele. O diretório padrão de ADRs é `.archgate/adrs/`, mas pode ser [personalizado](/reference/configuration/#diretorio-personalizado-de-adrs) após a inicialização.
