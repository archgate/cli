...
1. **Domain** -- um dos integrados `backend`, `frontend`, `data`, `architecture` ou `general`, mais quaisquer [domínios personalizados](/pt-br/concepts/domains/#domínios-personalizados) que o projeto tenha registrado via `archgate adr domain add`
...
| `--domain <name>` | Nome do domínio (integrado ou [personalizado](/pt-br/concepts/domains/#domínios-personalizados)) |
