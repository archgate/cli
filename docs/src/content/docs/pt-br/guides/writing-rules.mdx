...
:::note
Arquivos de regras sempre ficam ao lado de seus arquivos ADR complementares. Se voce configurar um [diretório personalizado de ADRs](/reference/configuration/#diretorio-personalizado-de-adrs), coloque os arquivos de regras lá também.
:::
