...
- [Padrões Comuns de Regras](/pt-br/examples/common-rule-patterns/) — Padrões prontos para copiar e colar para verificações de dependências, convenções de nomenclatura, restrições de import e mais.
- [Referência da API de Regras](/pt-br/reference/rule-api/) — Referência completa de todos os tipos e funções da API de regras.
