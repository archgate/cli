...
O plugin adiciona um agente e skills baseadas em papéis ao Claude Code. O agente orquestra o fluxo de guardrails, invocando skills conforme necessário -- ler as decisões antes de codificar, validar depois e capturar novos padrões para a equipe.
