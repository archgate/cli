...
A URL do marketplace não contém credenciais -- o git se autentica em `plugins.archgate.dev` usando o token que o `archgate login` entregou ao seu credential helper do git.
