...
| `domain` | string       | Sim         | Nome de domínio registrado. Integrados: `backend`, `frontend`, `data`, `architecture`, `general`. [Domínios personalizados](/pt-br/concepts/domains/#domínios-personalizados) podem ser adicionados via `archgate adr domain add`. |
