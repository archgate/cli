...
É esse pareamento que faz do Archgate o lint do trabalho com IA: cada checagem remete a uma decisão documentada, e as violações apontam o arquivo e a linha que as quebraram quando as regras informam esses dados.
