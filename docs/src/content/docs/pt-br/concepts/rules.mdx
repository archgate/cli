...
É esse pareamento que faz do Archgate o lint do trabalho com IA: cada checagem remete a uma decisão documentada, e cada violação aponta o arquivo e a linha que a quebrou.
