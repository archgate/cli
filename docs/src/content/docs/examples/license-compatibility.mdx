...
- **Add transitive scanning**: For deeper coverage, scan all `node_modules/*/package.json` instead of only direct dependencies (see a dedicated script approach for this).
