...
The generated files give you a working example to build on. The default ADR directory is `.archgate/adrs/`, but it can be [customized](/reference/configuration/#custom-adr-directory) after initialization.
