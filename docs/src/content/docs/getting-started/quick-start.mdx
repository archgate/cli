---
title: Quick Start
description: Get started with Archgate in under 5 minutes. Initialize a project, write your first lint rule for your architecture, and block violations with archgate check.
---
...
Want AI agents that automatically read your ADRs before coding? Run `archgate login` to sign in, then run `archgate init --install-plugin` to set up the plugin.
:::
