...
description: session-context --skip was removed entirely after two rounds of bugs — replaced with per-editor list/show subcommands
metadata:
  type: project
---
